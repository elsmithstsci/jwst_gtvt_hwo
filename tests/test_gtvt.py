""" HWO GENERAL AND MOVING TARGET VISIBILITY TOOL TESTS"""
import pytest
...
def test_ra_dec_hour_min_sec():
    """Test end-to-end for hwo_gtvt fixed target given ra and dec in hours:minutes:seconds"""
    eph = Ephemeris()
...
def test_ra_dec_sexigesimal():
    """Test end-to-end for hwo_gtvt fixed target given ra and dec in sexigesimal coords"""
    eph = Ephemeris()
